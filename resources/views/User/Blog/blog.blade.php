                        ...
                        <div class="row">
                                ...
                                <article class="single_blog mb-60">
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="/blog-details"><img src="{{asset('frontend/assets/img/blog/blog1.jpg')}}" alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                                            <h3><a href="/blog-details">bibendum massa nec, fermentum odio</a></h3>
                                            <div class="blog_meta">                                        
                            ...
                            <div class="col-lg-6 col-md-6">
                                <article class="single_blog mb-60">
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="/blog-details"><img src="{{asset('frontend/assets/img/blog/blog2.jpg')}}" alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                                            <h3><a href="/blog-details">Aenean posuere libero eu augue</a></h3>
                                            <div class="blog_meta">                                        
                                                <span class="author">Posted by : <a href="#">admin</a> / </span>
                                                <span class="post_date">On : <a href="#">April 10, 2019</a></span>
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <article class="single_blog">
                                    <figure>
                                        ...
                                        <figcaption class="blog_content">
                                            <h3><a href="/blog-details">Donec vitae hendrerit arcu, sit amet</a></h3>
                                            <div class="blog_meta">                                        
                                                <span class="author">Posted by : <a href="#">admin</a> / </span>
                                                <span class="post_date">On : <a href="#">April 10, 2019</a></span>
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <article class="single_blog">
                                    <figure>
                                        ...
                                        <figcaption class="blog_content">
                                            <h3><a href="/blog-details">Cras pretium arcu ex. Aenean</a></h3>
                                            <div class="blog_meta">                                        
                                                <span class="author">Posted by : <a href="#">admin</a> / </span>
                                                <span class="post_date">On : <a href="#">April 10, 2019</a></span>
                                            </div>
